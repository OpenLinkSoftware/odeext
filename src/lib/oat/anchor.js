/*
 *  $Id: anchor.js,v 1.47.4.8 2012/01/16 19:07:10 pvk Exp $
 *
				...
				if (OAT.AJAX && OAT.AJAX.requests.length) {
					...
					while (OAT.Dom.getWH(win.dom.content)[1]+50 > OAT.Dom.getWH(win.dom.container)[1]) {
						...
						if (height == OAT.Dom.getWH(win.dom.content)[1]) {
							if (OAT.Dom.getWH(win.dom.container)[1] > 100) win.dom.container.style.width = (OAT.Dom.getWH(win.dom.container)[0]-100)+'px';
