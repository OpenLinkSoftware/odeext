/*
 *  $Id: rdftabs.js,v 1.107.4.16 2012/01/16 19:07:13 pvk Exp $
 *
...
OAT.RDFTabs.navigator = function(parent,optObj) {
	...
	this.drawItem = function(item) { /* one item */
		...
		self.drawSpotlight(self.parent.getTitle(item),item.uri,obj);
	}
	...
	this.drawSpotlight = function(title,uri,obj) { /* list of resources */
		...
		var t_elm = OAT.Dom.create("h3",{className:"rdf_nav_item_title"});
