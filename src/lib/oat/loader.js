/*
 *  $Id: loader.js,v 1.156.4.20 2012/05/07 09:01:20 pvk Exp $
 *
...
OAT.Preferences = {
    ...
    endpointXmla: "/XMLA",
    version: "2.9.12",
    build: "$Date: 2012/05/07 09:01:20 $",
    httpError: 1, /* show http errors */
    allowDefaultResize: 1,
    allowDefaultDrag: 1,
    ajax_http_headers:  null   /* [{header:"Cookie", value:"test1"},{header:"Referer", value:"test2"} ]*/
}
...
//    isIE:(document.attachEvent && !document.addEventListener),
    isIE:((document.attachEvent && !document.addEventListener) || !!navigator.userAgent.match(/msie 9/i)  || !!navigator.userAgent.match(/msie 10/i)  || !!navigator.userAgent.match(/msie 11/i) || !!navigator.userAgent.match(/msie 12/i)),
    isIE7:(!!navigator.userAgent.match(/msie 7/i) || !!navigator.userAgent.match(/msie 9/i) || !!navigator.userAgent.match(/msie 10/i) || !!navigator.userAgent.match(/msie 11/i) || !!navigator.userAgent.match(/msie 12/i)),
