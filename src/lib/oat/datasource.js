/*
 *  $Id: datasource.js,v 1.19.4.12 2012/05/07 08:58:27 pvk Exp $
 *
...
OAT.DataSource = function(type) {
    var self = this;
    this.name = "";
    this.type = type; /* 0 none, 1 sql, 2 wsdl, 3 rest, 4 sparql, 5 gdata, 6: loc */
    this.options = {};
...
/*    case OAT.DataSourceData.TYPE_GEOLOC:
	...
	self.options.xpath = 0;
	self.inputFields = [];
	self.outputLabels = ["Latitude", "Longitude", "Altitude", "Precision"];
	self.outputFields = [];
	break; */
    }
	...
	case OAT.DataSourceData.TYPE_GEOLOC: return "GEOLOC";break;
	}
	return "";
    }
